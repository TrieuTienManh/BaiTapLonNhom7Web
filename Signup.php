...
<body>
    ...
    <form action= "process_signup.php" method="post">
        <div class="mb-3">
            ...
            <input type="text" name = "txtUsername" class="form-control" id="" aria-describedby="">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="txtPassword1" class="form-control" id="exampleInputPassword1">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Retype Password</label>
            <input type="password" name="txtPassword2" class="form-control" id="exampleInputPassword1">
        </div>
